...
- **Project Bootstrapping** - Quickly scaffold new ForgeScript projects.
- **Smart Scaffolding** - Generate files and folders with proper structure.
...
- [Documentation](https://botforge.org/)
- [GitHub Issues](https://github.com/tryforge/CLI/issues)
- [Discord Community](https://botforge.org/discord)
